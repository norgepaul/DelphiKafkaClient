...
DelphiKafkaClient is a cross platform Delphi wrapper for Apache Kafka which currently supports Windows (i386/x64) and Linux (x64). Tested on Delphi 10.4, but should work on most modern Delphi releases.
